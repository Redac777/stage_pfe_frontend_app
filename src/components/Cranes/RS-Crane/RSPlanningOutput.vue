<template>
  ...
  export default {
    ...
    computed: {
      ...mapGetters(["getCurrentRSPlanning", "getPlanningBoxes"]),
          ...
          if (this.planning) {
            ...
            this.setPlanningBoxes(planningId).then(() => {
              ...
              uniqueUsers.forEach((userId) => {
                ...
                const { user, start_time, ends_time, break: isBreak,equipement } = box;
                  ...
                  if (!this.userWorkingHours[user.id]) {
                    ...
                    if(equipement.matricule==="SBY"){
                      this.userWorkingHours[user.id] = {
                        ...
                        totalSBYWorkingHours:user.sby_workingHours + workingMinutes
              ...
              const userToUpdate = {
                ...
                sby_workingHours: this.userWorkingHours[userId]?.totalSBYWorkingHours || 0
              };
